class DocumentsController < ApplicationController
 before_action :require_user_logged_in
  def show
    ...
    @translation=@document.translations.find_by(document_id: @document.id )
   end
  ...
  def create
    ...
    if @document = @upload.update(content: @str,diff: @str)
  ...
  private
  def document_params
    params.require(:document).permit(:image,:content,:diff)
  end
  def correct_user
